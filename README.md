...
flowchart LR
    ...
    SR[(Ken's Skills)]
    U2[Ken]
    U2 -->|Use upskill to share yyy| SR
    SR -->|Use upskill to get yyy skill from Ken| U1
    style U1 fill: #e1f5fe
    style SR fill: #fff3e0
    style U2 fill: #e8f5e9
```
...
- Install: `https://raw.githubusercontent.com/mingzilla/upskill/main/.install/guide__install/install__starter.md`
